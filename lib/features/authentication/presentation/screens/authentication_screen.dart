              ...
              child: BlocConsumer<AuthenticationBloc, AuthenticationState>(
                listener: (context, state) {
                  if (state is AuthenticationLoadedState) {
                    ...
                    global.appStorage
                        .write("apiUserName", _emailController.text);
                    global.appStorage
                        .write("apiUserPassword", _passwordController.text);
                    ...
                    children: [
                              ...
                              if (logoTouch >= 5) {
                                if (global.environmentVersion == "PROD") {
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content:
                                          Text("Develop Mode Active$logoTouch"),
                      ...
                      if (global.getAppversion() != '')
                        Container(
                            ...
                            child: Text(
                                "* ${global.getAppversion().replaceAll("(", "").replaceAll(")", "")} Mode",
