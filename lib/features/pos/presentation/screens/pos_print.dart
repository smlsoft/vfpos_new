...
class PosPrintBillClass {
  ...
  Future<List<PosPrintBillCommandModel>> buildCommand(
      global.PosScreenModeEnum posScreenMode) async {
    ...
    BillObjectBoxStruct? bill = global.billHelper.selectByDocNumber(
        docNumber: docNo, posScreenMode: global.posScreenToInt(posScreenMode));
  ...
  void printBillByBluetoothImageMode(
      global.PosScreenModeEnum posScreenMode) async {
  ...
  // void printBillByWindowsImageMode(
  //     global.PosScreenModeEnum posScreenMode) async {
  //   try {
