...
part 'promotion_struct.g.dart';

@JsonSerializable()
class PromotionStruct {
  // หัวข้อส่วนลด
  ...
  factory PromotionStruct.fromJson(Map<String, dynamic> json) =>
      _$PromotionStructFromJson(json);
  Map<String, dynamic> toJson() => _$PromotionStructToJson(this);
...
class PromotionDiscountStruct {
  ...
  factory PromotionDiscountStruct.fromJson(Map<String, dynamic> json) =>
      _$PromotionDiscountStructFromJson(json);
  Map<String, dynamic> toJson() => _$PromotionDiscountStructToJson(this);
...
class PromotionTempStruct {
  ...
  factory PromotionTempStruct.fromJson(Map<String, dynamic> json) =>
      _$PromotionTempStructFromJson(json);
  Map<String, dynamic> toJson() => _$PromotionTempStructToJson(this);
...
class PromotionProcessByProduct {
  late String barcode;
  late double amount;
  late double sum_qty;
  late double extra_amount;

  PromotionProcessByProduct(
