...
class SyncCategory {
  ...
  List<SyncCategoryCodeList>? codelist; // รหัสสินค้าย่อย
  ...
  factory SyncCategory.fromJson(Map<String, dynamic> json) =>
      _$SyncCategoryFromJson(json);

  Map<String, dynamic> toJson() => _$SyncCategoryToJson(this);
}

@JsonSerializable(explicitToJson: true)
class SyncCategoryCodeList {
  String code;
  List<LanguageDataModel> names;
  int xorder;
  String barcode;
  ...
  factory SyncCategoryCodeList.fromJson(Map<String, dynamic> json) =>
      _$SyncCategoryCodeListFromJson(json);

  Map<String, dynamic> toJson() => _$SyncCategoryCodeListToJson(this);
}
