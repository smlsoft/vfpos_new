...
SyncCategory _$SyncCategoryFromJson(Map<String, dynamic> json) => SyncCategory(
      guidfixed: json['guidfixed'] as String,
      ...
      codelist: (json['codelist'] as List<dynamic>?)
          ?.map((e) => SyncCategoryCodeList.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$SyncCategoryToJson(SyncCategory instance) =>
    <String, dynamic>{
      'guidfixed': instance.guidfixed,
...
SyncCategoryCodeList _$SyncCategoryCodeListFromJson(
        Map<String, dynamic> json) =>
    SyncCategoryCodeList(
...
Map<String, dynamic> _$SyncCategoryCodeListToJson(
        SyncCategoryCodeList instance) =>
    <String, dynamic>{
      'code': instance.code,
      'names': instance.names.map((e) => e.toJson()).toList(),
