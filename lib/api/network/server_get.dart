...
Future<void> serverGet(HttpRequest request, HttpResponse response) async {
  if (request.uri.path == '/scan') {
    ...
    HttpGetDataModel httpGetData =
        HttpGetDataModel.fromJson(jsonDecode(utf8.decode(base64Decode(json))));
    switch (httpGetData.code) {
        ...
        final result = box
            .query(OrderTempObjectBoxStruct_.kdsId
                ...
                .and((OrderTempObjectBoxStruct_.isOrderSendKdsSuccess
                    .equals(true)))
                .and((OrderTempObjectBoxStruct_.kdsSuccess.equals(false)).or(
                    OrderTempObjectBoxStruct_.kdsSuccessTime
                ...
                .query(OrderTempObjectBoxStruct_.orderId.equals(orderId).and(
                    OrderTempObjectBoxStruct_.barcode
                        ...
                        .and(OrderTempObjectBoxStruct_.isPaySuccess
                            .equals(false))
                        .and(
                            OrderTempObjectBoxStruct_.isOrder.equals(isOrder))))
                .build()
                .find()
            : box
      ...
      case "staff.order_temp_get_data_from_order_guid":
        ...
        final box = global.objectBoxStore.box<OrderTempObjectBoxStruct>();
        final result = box
            .query(OrderTempObjectBoxStruct_.orderGuid.equals(orderGuid))
            .build()
            .findFirst();
        if (result != null) {
      ...
      case "staff.get_all_delivery_ticket":
        ...
        List<TableProcessObjectBoxStruct> boxData = global.objectBoxStore
            ...
            .query(TableProcessObjectBoxStruct_.is_delivery.equals(true).and(
                TableProcessObjectBoxStruct_.delivery_send_success
                    .equals(sendSuccess)))
      ...
      case "get_all_buffet_mode":
        List<BuffetModeObjectBoxStruct> boxData =
            global.objectBoxStore.box<BuffetModeObjectBoxStruct>().getAll();
        response.write(jsonEncode(boxData.map((e) => e.toJson()).toList()));
        break;
      case "get_table":
        var jsonData = jsonDecode(httpGetData.json);
        ...
        TableProcessObjectBoxStruct? tableData = global.objectBoxStore
            ...
            .query(TableProcessObjectBoxStruct_.number
                .equals(tableNumber)
                .and(TableProcessObjectBoxStruct_.is_delivery.equals(false)))
            .build()
            .findFirst();
        if (tableData == null) {
          // เพิ่มโต๊ะ
          final findSourceTableResult = global.objectBoxStore
              .box<TableProcessObjectBoxStruct>()
              .query(TableProcessObjectBoxStruct_.number.equals(mainNumber))
              .build()
              .findFirst();
      ...
      case "get_all_table":
        ...
        for (var table in tableData) {
          ...
          var data = global.objectBoxStore
              .box<TableProcessObjectBoxStruct>()
              .query(
                  TableProcessObjectBoxStruct_.number_main.equals(table.number))
              .build()
              .find();
      ...
      case "get_all_category":
        List<ProductCategoryObjectBoxStruct> boxData = global.objectBoxStore
            .box<ProductCategoryObjectBoxStruct>()
            .getAll();
        response.write(jsonEncode(boxData.map((e) => e.toJson()).toList()));
        break;
      case "get_all_kitchen":
        List<KitchenObjectBoxStruct> boxData =
            global.objectBoxStore.box<KitchenObjectBoxStruct>().getAll();
        response.write(jsonEncode(boxData.map((e) => e.toJson()).toList()));
        break;
      case "get_all_barcode":
        List<ProductBarcodeObjectBoxStruct> boxData =
            global.objectBoxStore.box<ProductBarcodeObjectBoxStruct>().getAll();
        response.write(jsonEncode(boxData.map((e) => e.toJson()).toList()));
        break;
      case "PosLogHelper.selectByGuidFixed":
        ...
        List<PosLogObjectBoxStruct> boxData = (box.query(PosLogObjectBoxStruct_
                .guid_auto_fixed
