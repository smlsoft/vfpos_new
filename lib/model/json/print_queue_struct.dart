...
part 'print_queue_struct.g.dart';

@JsonSerializable()
class PrintQueueStruct {
  late String guid;
  ...
  PrintQueueStruct(
      ...
      : this.guid = Uuid().v4();
  factory PrintQueueStruct.fromJson(Map<String, dynamic> json) =>
      _$PrintQueueStructFromJson(json);
  Map<String, dynamic> toJson() => _$PrintQueueStructToJson(this);
