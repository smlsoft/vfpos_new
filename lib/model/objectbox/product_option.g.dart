...
ProductOptionStruct _$ProductOptionStructFromJson(Map<String, dynamic> json) =>
    ProductOptionStruct(
      ...
      choices: (json['choices'] as List<dynamic>)
          .map((e) => ProductChoiceStruct.fromJson(e as Map<String, dynamic>))
          .toList(),
    )..select_index = json['select_index'] as int;

Map<String, dynamic> _$ProductOptionStructToJson(
        ProductOptionStruct instance) =>
    <String, dynamic>{
...
ProductChoiceStruct _$ProductChoiceStructFromJson(Map<String, dynamic> json) =>
    ProductChoiceStruct(
      guid_fixed: json['guid_fixed'] as String,
...
Map<String, dynamic> _$ProductChoiceStructToJson(
        ProductChoiceStruct instance) =>
    <String, dynamic>{
      'guid_fixed': instance.guid_fixed,
