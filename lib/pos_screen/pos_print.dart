...
Future<void> printBill(String docNo) async {
  ...
  if (res == PosPrintResult.success) {
    ...
    printer.reset();
    //
    PrintProcess printProcess = PrintProcess(length: 48);
    //
    ...
    printProcess.columnWidth.add(20);
    printProcess.columnWidth.add(5);
    ...
    for (var detail in billDetails) {
      /// สินค้าทั่วไป
      printProcess.column.clear();
      String desc = "${detail.item_name} ${detail.unit_name}";
